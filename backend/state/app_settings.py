...
def to_settings_response(settings: AppSettings) -> SettingsResponse:
    ...
    data["has_openai_compatible_api_key"] = bool(openai_key.strip())
    ...
    data["has_ltx_api_key"] = bool(ltx_key.strip())
    data["has_fal_api_key"] = bool(fal_key.strip())
    data["has_gemini_api_key"] = bool(gemini_key.strip())
