...
import {
  ...
  DEFAULT_OPENROUTER_ROLE_MODELS,
  type AppSettings,
  type ClearableKeyProvider,
  type DirectorProviderSetting,
  type FastModelSettings,
  type InferenceSettings,
  type OpenRouterRoleModels,
} from '../types/settings'

// Re-exported so existing call sites keep importing the settings contract from
// the context they already use.
export {
  API_KEY_FIELDS,
  DEFAULT_APP_SETTINGS,
  DEFAULT_OPENROUTER_ROLE_MODELS,
