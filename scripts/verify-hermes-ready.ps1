...
$miss = 0
$files = @('scripts\start-backend.ps1','scripts\start-backend.sh','scripts\setup-dev.ps1','scripts\setup-dev.sh','scripts\ensure-wan2gp.ps1','scripts\ensure-wan2gp.sh',
